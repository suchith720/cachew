...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/cachew/01_cachew-for-wikiseealsotitles-with-meta-loss-004'
    ...
    args = XCLearningArguments(
        ...
        data_augmentation_attribute='data_enriched_repr',
        ...
        label_names=[f'{meta_name}2data_idx', f'{meta_name}2data_data2ptr', f'p{meta_name}2data_idx', f'p{meta_name}2data_data2ptr', 
            f'{meta_name}2lbl_idx', f'{meta_name}2lbl_lbl2ptr', f'{meta_name}2lbl_data2ptr', f'p{meta_name}2lbl_idx', 
            f'p{meta_name}2lbl_lbl2ptr', f'p{meta_name}2lbl_data2ptr'],
