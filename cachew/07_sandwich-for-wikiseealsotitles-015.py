...
from xcai.models.sandwich import SAW004, SandwichConfig
...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/sandwich/07_sandwich-for-wikiseealsotitles-015'
    ...
    def model_fn(mname):
        model = SAW004.from_pretrained(mname, config=config)
        return model
