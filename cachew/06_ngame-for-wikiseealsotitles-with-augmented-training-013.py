...
def get_lbl_lbl_metadata(block, meta_name:str, batch_size:int=1024, thresh:int=10, topk:int=10, do_normalize:bool=True):
...
def get_data_lbl_metadata(block, meta_name:str, batch_size:int=1024, topk:int=10):
    if f'{meta_name}_meta' not in block.train.dset.meta: raise ValueError(f'Invalid metadata: {meta_name}')
...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/cachew/06_ngame-for-wikiseealsotitles-with-augmented-training-013'
    ...
    train_dset = get_data_lbl_metadata(block, 'cat') 
