# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/05_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory.ipynb 3
import os,torch,json, torch.multiprocessing as mp, joblib, numpy as np, scipy.sparse as sp

from xcai.main import *
from xcai.basics import *

from xcai.models.cachew import CAW003, CachewConfig

# %% ../nbs/05_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory.ipynb 5
os.environ['CUDA_VISIBLE_DEVICES'] = '8,9'
os.environ['WANDB_PROJECT'] = 'cachew_00-wikiseealsotitles'

# %% ../nbs/05_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory.ipynb 7
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/cachew/05_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory-001'
    ...
    args = XCLearningArguments(
        ...
        num_clustering_warmup_epochs=0, # 10,
    ...
    num_keys = int(np.ceil(np.sqrt(num_metadata + 1)))
    ...
    config = CachewConfig(
        ...
        mem_output_dim=768,
        mem_v_dim=-1,
        mem_num_keys=num_keys, 
        mem_share_values=False, 
        mem_use_peer_variant=True, 
        mem_num_metadata=num_metadata
    )
    
    model = CAW003.from_pretrained('sentence-transformers/msmarco-distilbert-base-v4', config=config)
