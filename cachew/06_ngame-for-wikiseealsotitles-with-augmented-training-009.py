...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/cachew/06_ngame-for-wikiseealsotitles-with-augmented-training-009'
    ...
    block.train.dset.get_one_hop_metadata(topk=10)
    block.train.dset.meta['ohm_meta'].lbl_meta = block.train.dset.meta['ohm_meta'].lbl_meta.transpose().tocsr()
    train_dset = block.train.dset.combine_data_and_meta(meta_name='ohm')
