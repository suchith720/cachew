...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/cachew/05_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory-002'
    ...
    num_keys = num_keys + (4 - num_keys%4)
