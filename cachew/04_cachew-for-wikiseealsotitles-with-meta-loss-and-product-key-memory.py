# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/04_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory.ipynb 3
...
# %% ../nbs/04_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory.ipynb 5
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT'] = 'cachew_00-wikiseealsotitles'

# %% ../nbs/04_cachew-for-wikiseealsotitles-with-meta-loss-and-product-key-memory.ipynb 7
