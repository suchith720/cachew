# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_cachew-for-wikiseealsotitles.ipynb.
...
from xcai.models.cachew import Encoder, EncoderOutput, Parameters, Memory

@patch
def forward(self:Memory, input_embeds:torch.Tensor, input_indices:Optional[torch.Tensor]=None, input_data2ptr:Optional[torch.Tensor]=None):
...
@patch
def enrich_query_representation(self:Encoder, data_repr:torch.Tensor, meta_kwargs:Optional[Dict]=None):
...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/cachew/00_cachew-for-wikiseealsotitles-002'
    ...
    model = CAW001.from_pretrained(mname, config=config)
