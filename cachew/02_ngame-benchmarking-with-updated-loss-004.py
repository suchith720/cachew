...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/cachew/02_ngame-benchmarking-with-updated-loss-004'
    ...
    pkl_file = f'{pkl_file}_lbl-cat-sep-128.joblib'

    do_inference = input_args.do_train_inference or input_args.do_test_inference or input_args.save_train_prediction or input_args.save_test_prediction or input_args.save_representation

    os.makedirs(os.path.dirname(pkl_file), exist_ok=True)
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, only_test=input_args.only_test, data_dir=data_dir, meta_name='cat', data_seq_length=128, lbl_seq_length=128, exclude_sep=False, do_data_meta_aug=False, do_lbl_meta_aug=True, sampling_features=[('lbl2data',1)])
